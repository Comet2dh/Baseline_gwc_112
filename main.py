...
parser.add_argument('--cuda', default='5', help='CUDA_VISIBLE_DEVICES')
    ...
    for epoch_idx in range(start_epoch, args.epochs):
        ...
        for batch_idx, sample in enumerate(TrainImgLoader):
            ...
            if do_summary:
                ...
                # CAM visualization, cam: D*C*H*W
                # map_name = 'CAM/{}'.format('classifier1')
                # logger.add_image(map_name,
                #                  vutils.make_grid(cam, padding=5, normalize=True, scale_each=True),
                #                  global_step)
...
def train_sample(sample, compute_metrics=False):
    ...
    image_outputs = {"disp_est": disp_ests[1:], "disp_gt": disp_gt, "imgL": imgL, "imgR": imgR}
    if compute_metrics:
        with torch.no_grad():
